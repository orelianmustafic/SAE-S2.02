...
public class Main {
    public static final String GRAPHES_REP = "graphes/orig";
    public static final String REPONSES_REP = "reponses/orig";
    ...
    private static long chronoTousLesGraphesDeType(IGraphe g) {
        ...
        for (CheminATrouver cat : importer) {
            dureeTotale += chrono(cat.getGraph(), cat.getSDArc().getSource(),
                    cat.getSDArc().getDestination(), cat.getDistanceAttendue());
        }
        return dureeTotale;
    }
